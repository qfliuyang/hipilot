...
> **Note:** This is the original Phase 1 design specification. The actual implementation has evolved (7 tools, JavaScript instead of TypeScript). See [../mcp-servers.md](../mcp-servers.md) for the current API reference.
