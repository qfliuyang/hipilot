# Sent at: 2026-03-02T11:48:24.082Z
# Pane: eda
...
# Stage 1: Init Design
init_design
puts "=== STAGE 1 COMPLETE: INIT DESIGN ==="
...
puts "=== STAGE 3 COMPLETE: POWER PLANNING ==="

# Stage 4: Placement (ignore scan chain errors - design has DFT from synthesis)
...
# Use place_design instead of place_opt_design to avoid timing library issues
# Place with scan chains ignored - design has DFT from synthesis
if {[catch {place_design} err]} {
    puts "Placement had issues: $err"
...
report_ccopt_skew_groups > result/pr/report/ccopt_skew.rpt
saveDesign result/pr/data/cts.enc
puts "=== STAGE 5 COMPLETE: CTS ==="
puts "Checkpoint saved: result/pr/data/cts.enc"
exit