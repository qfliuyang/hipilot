# Sent at: 2026-03-02T11:49:16.969Z
# Pane: eda
...
# Load scan DEF NOW - right after init before any other operations
puts "Loading scan DEF file..."
if {[catch {loadDef /home/EDA/ibex_work_upload/result/scanchain/data/ibex_core.scan.def} err]} {
    puts "Could not load scan DEF: $err"
    puts "Will try to continue anyway..."
}
puts "Scan DEF load attempt complete"
