# Sent at: 2026-03-03T12:19:56.492Z
# Pane: eda

cd /home/EDA/ibex_work_upload

# Skip synthesis if netlist already exists
if {[file exists result/syn/data/ibex_core.syn.v]} {
    puts "SYNTHESIS ALREADY COMPLETE - netlist exists at result/syn/data/ibex_core.syn.v"
    puts "Skipping to Stage 1 (Design Init)"
    exit 0
}

puts "Netlist not found - running synthesis..."
