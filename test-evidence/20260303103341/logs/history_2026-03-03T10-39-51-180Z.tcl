# Sent at: 2026-03-03T10:39:51.180Z
# Pane: eda
...
# Verify analysis views are set
puts "Active analysis views: [all_analysis_views]"
puts "Active setup views: [get_analysis_view -setup]"
puts "Active hold views: [get_analysis_view -hold]"
