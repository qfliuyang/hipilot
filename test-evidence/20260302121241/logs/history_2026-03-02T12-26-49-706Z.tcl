# Sent at: 2026-03-02T12:26:49.706Z
# Pane: eda

cd /home/EDA/ibex_work_upload
file mkdir result/pr/data result/pr/log result/pr/report

# Create MMMC file first
set mmmc_file [open "result/pr/data/mmmc.tcl" w]
puts $mmmc_file "set timing_lib /home/EDA/ibex_work_upload/designs/sky130hd/pdk/lib/sky130_fd_sc_hd__tt_025C_1v80.db"
...
# Design init - set MMMC file BEFORE init_design
set defHierChar {/}
...
set init_mmmc_file result/pr/data/mmmc.tcl
init_design
