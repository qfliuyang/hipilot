# Sent at: 2026-03-02T14:24:35.591Z
# Pane: eda
...
# CRITICAL FIX: Save checkpoint BEFORE timeDesign (which may fail)
saveDesign result/pr/data/init_design.enc
puts "CHECKPOINT SAVED: init_design.enc"

# Now try timing analysis (may fail, but checkpoint is safe)
