...
import {
  TOOL_DEFINITIONS as STATUS_TOOL_DEFINITIONS,
  TOOL_HANDLERS as STATUS_TOOL_HANDLERS,
} from './tools/status.js';
import {
  TOOL_DEFINITIONS as QOR_TOOL_DEFINITIONS,
  TOOL_HANDLERS as QOR_TOOL_HANDLERS,
} from './tools/qor.js';
import {
  TOOL_DEFINITIONS as REPORT_ANALYSIS_TOOL_DEFINITIONS,
  TOOL_HANDLERS as REPORT_ANALYSIS_TOOL_HANDLERS,
} from './tools/report-analysis.js';
import {
  TOOL_DEFINITIONS as JOBS_TOOL_DEFINITIONS,
  TOOL_HANDLERS as JOBS_TOOL_HANDLERS,
} from './tools/jobs.js';
import {
  TOOL_DEFINITIONS as ERROR_ANALYSIS_TOOL_DEFINITIONS,
  TOOL_HANDLERS as ERROR_ANALYSIS_TOOL_HANDLERS,
} from './tools/error-analysis.js';
import {
  TOOL_DEFINITIONS as TCL_FILE_IO_TOOL_DEFINITIONS,
  TOOL_HANDLERS as TCL_FILE_IO_TOOL_HANDLERS,
} from './tools/tcl-file-io.js';
import {
  TOOL_DEFINITIONS as FLOW_VALIDATION_TOOL_DEFINITIONS,
  TOOL_HANDLERS as FLOW_VALIDATION_TOOL_HANDLERS,
} from './tools/flow-validation.js';
...
server.setRequestHandler(ListToolsRequestSchema, async () => {
  return {
    tools: [
      ...
      // QoR tools
      ...QOR_TOOL_DEFINITIONS,
      // Report analysis tools
      ...REPORT_ANALYSIS_TOOL_DEFINITIONS,
      // Job monitoring tools
      ...JOBS_TOOL_DEFINITIONS,
      // Error analysis tools
      ...ERROR_ANALYSIS_TOOL_DEFINITIONS,
      // Tcl file I/O tools
      ...TCL_FILE_IO_TOOL_DEFINITIONS,
      // Flow validation tools
      ...FLOW_VALIDATION_TOOL_DEFINITIONS,
...
const ALL_TOOL_HANDLERS = {
  ...
  ...STATUS_TOOL_HANDLERS,
  ...QOR_TOOL_HANDLERS,
  ...REPORT_ANALYSIS_TOOL_HANDLERS,
  ...JOBS_TOOL_HANDLERS,
  ...ERROR_ANALYSIS_TOOL_HANDLERS,
  ...TCL_FILE_IO_TOOL_HANDLERS,
  ...FLOW_VALIDATION_TOOL_HANDLERS,
};
...
**Available tools:** innovus, dc_shell, pt_shell, icc2_shell` }],
      ...
      // === eda.edit_tcl and eda.save_tcl extracted to tools/tcl-file-io.js ===
